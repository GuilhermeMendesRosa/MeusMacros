...
import br.com.roselabs.meus_macros.data.AuthenticationTokens;
import br.com.roselabs.meus_macros.data.LoginRequestRecord;
...
import br.com.roselabs.meus_macros.services.UserService;
...
public class UserController {
    ...
    public ResponseEntity<Void> register(@RequestBody RegisterRequestRecord registerRequest) {
        try {
            ...
            this.userService.createDefaultGoal(user);
